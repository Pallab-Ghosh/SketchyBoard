...
export const Toolbar = ({canvasState,setCanvasState,undo,redo,canUndo,canRedo}:ToolbarProps) => {
  ...
  return (
       <div className="absolute top-[50%] -translate-y-[50%] left-2 flex flex-col gap-y-4">
            <div className=" bg-white rounded-md p-1.5 flex gap-y-1 flex-col items-center shadow-md">
                      ...
                      isActive={CanvasMode.None === canvasState.mode }
                      />
                     ...
                     <ToolButton
                      ...
                      isActive={CanvasMode.Inserting === canvasState.mode}
                      />
 ...
 export const ToolbarSkeleton = ()=>{
    return(
      <Skeleton className="absolute top-[50%] shadow-md  -translate-y-[50%] left-2 flex flex-col gap-y-4 h-[360px] w-[52px] bg-neutral-300"/>
    )
 }